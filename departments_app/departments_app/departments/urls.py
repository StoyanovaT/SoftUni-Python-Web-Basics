...
urlpatterns = (
    ...
    path('<department_id>/', show_departments_details, name='show department details with string'),

    # /departments/int/{department_id}/
    path('int/<int:department_id>/', show_departments_details, name='show department details'),
